        ...
        '<div class="pickadate" ng-show="displayPicker" ng-style="modalStyles">' +
          ...
          '<div class="pickadate-body">' +
            '<div class="pickadate-main">' +
              ...
              '</ul>' +
              '<ul class="pickadate-cell">' +
              	'<a ng-repeat="dateObj in dates" ng-class="classesFor(dateObj)" ng-href="#calendar/day/{{dateObj.formattedDate}}">' +
	                '<li>' +
	                  '{{dateObj.date | date:"d"}}' +
	                 '</li>' +
                 '</a>' +
      ...
      return {
        ...
        link: function(scope, element, attrs, ngModel)  {
          ...
          scope.setDate = function(dateObj) {
            ...
            scope.displayPicker = !wantsModal;
            console.log(dateObj.formattedDate);
          };
          ...
          scope.changeMonth = function(offset) {
            ...
            ngModel.$setViewValue(dateHelper.buildDateObject(dateHelper.parseDate(scope.currentDate)).formattedDate);
            render();
          };
